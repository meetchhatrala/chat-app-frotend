...
export const Chat = (props) => {
  ...
  useEffect(() => {
    if (props.selectedFriend) {
      ...
      var data = props.selectedFriend.split('-')
  ...
  useEffect(() => {
    if (props.selectedFriend && username) {

      var selected_friend = props.selectedFriend.split('-')
  ...
  }, [props.selectedFriend, socketRef, username, navigate])
